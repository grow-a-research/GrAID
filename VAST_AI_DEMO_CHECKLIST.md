...
Current instance: **47646208** (1x RTX 5060 Ti, datacenter host) — Public IP `85.10.218.46` (Static).
OCR server runs on internal port `10100`, mapped to external port `35102`.

## Part 1 — Start the remote OCR server

1. Log into Vast.ai -> **Instances** page. Confirm instance **47646208** shows "Running."
...
5. Verify it's reachable from outside the instance — from your own machine's browser or terminal:
   ```
   http://85.10.218.46:35102/health
   ```
...
- Paste `http://85.10.218.46:35102` when asked for the remote OCR URL.
...
1. On the Instances page, click the black square (**Stop**) icon on instance 47646208.
